...
// ═══════════════════════════════════════════════════════════
function injectMainAds() { /* AdSense removed */ }
...
// ═══════════════════════════════════════════════════════════
(function _initTheme() {
  var saved = localStorage.getItem('anthros_theme') || 'light';
...
function toggleTheme() {
  ...
  localStorage.setItem('anthros_theme', next);
  // Update moon icon
  ...
  if (meta) meta.content = next === 'dark' ? '#0C0C10' : '#FFFFFF';
}
window.toggleTheme = toggleTheme;

// ═══════════════════════════════════════════════════════════
// i18n — Auto-detect phone language (en / es / pt)
// ═══════════════════════════════════════════════════════════
var LANG = (function () {
...
var T = {
  en: {
    greeting_morning: 'Good Morning', greeting_day: "Let's Work", greeting_night: 'Evening Grind',
    today: 'Today', calories: 'Calories', protein: 'Protein', carbs: 'Carbs', fats: 'Fats',
    water: 'Water', steps: 'Steps', goal: 'Goal', add_food: 'Add Food', scan: 'Scan',
    home: 'Home', nutrition: 'Nutrition', workout: 'Workout', progress: 'Progress', more: 'More',
    ai_coach: 'AI Coach', supplements: 'Supplements', fasting: 'Fasting',
    breakfast: 'Breakfast', lunch: 'Lunch', dinner: 'Dinner', snack: 'Snack',
    kcal_goal: 'kcal goal', pro_goal: 'protein goal', saved: 'Saved', error: 'Error',
    loading: 'Loading', send: 'Send', type_message: 'Ask your coach...',
    daily_report: 'Daily Report', burned: 'Burned', consumed: 'Consumed', remaining: 'Remaining',
    weight: 'Weight', sleep: 'Sleep', mood: 'Mood', notes: 'Notes', profile: 'Profile',
    settings: 'Settings', logout: 'Log Out', pro_badge: 'PRO', free_badge: 'FREE',
    glass: 'glasses', of: 'of', per_day: '/ day', week: 'weeks'
  },
  es: {
    greeting_morning: 'Buenos Días', greeting_day: 'A Trabajar', greeting_night: 'Buenas Noches',
    today: 'Hoy', calories: 'Calorías', protein: 'Proteína', carbs: 'Carbos', fats: 'Grasas',
    water: 'Agua', steps: 'Pasos', goal: 'Objetivo', add_food: 'Agregar', scan: 'Escanear',
    home: 'Inicio', nutrition: 'Nutrición', workout: 'Entreno', progress: 'Progreso', more: 'Más',
    ai_coach: 'Coach IA', supplements: 'Suplementos', fasting: 'Ayuno',
    breakfast: 'Desayuno', lunch: 'Almuerzo', dinner: 'Cena', snack: 'Snack',
    kcal_goal: 'kcal objetivo', pro_goal: 'proteína objetivo', saved: 'Guardado', error: 'Error',
    loading: 'Cargando', send: 'Enviar', type_message: 'Pregunta a tu coach...',
    daily_report: 'Reporte Diario', burned: 'Quemado', consumed: 'Consumido', remaining: 'Restante',
    weight: 'Peso', sleep: 'Sueño', mood: 'Ánimo', notes: 'Notas', profile: 'Perfil',
    settings: 'Ajustes', logout: 'Cerrar Sesión', pro_badge: 'PRO', free_badge: 'FREE',
    glass: 'vasos', of: 'de', per_day: '/ día', week: 'semanas'
  },
  pt: {
    greeting_morning: 'Bom Dia', greeting_day: 'Vamos Trabalhar', greeting_night: 'Boa Noite',
    today: 'Hoje', calories: 'Calorias', protein: 'Proteína', carbs: 'Carboidratos', fats: 'Gorduras',
    water: 'Água', steps: 'Passos', goal: 'Objetivo', add_food: 'Adicionar', scan: 'Escanear',
    home: 'Início', nutrition: 'Nutrição', workout: 'Treino', progress: 'Progresso', more: 'Mais',
    ai_coach: 'Coach IA', supplements: 'Suplementos', fasting: 'Jejum',
    breakfast: 'Café da Manhã', lunch: 'Almoço', dinner: 'Jantar', snack: 'Lanche',
    kcal_goal: 'kcal objetivo', pro_goal: 'objetivo de proteína', saved: 'Salvo', error: 'Erro',
    loading: 'Carregando', send: 'Enviar', type_message: 'Pergunte ao seu coach...',
    daily_report: 'Relatório Diário', burned: 'Queimado', consumed: 'Consumido', remaining: 'Restante',
    weight: 'Peso', sleep: 'Sono', mood: 'Humor', notes: 'Notas', profile: 'Perfil',
    settings: 'Configurações', logout: 'Sair', pro_badge: 'PRO', free_badge: 'FREE',
    glass: 'copos', of: 'de', per_day: '/ dia', week: 'semanas'
  }
};
window.T = T;
...
// Apply i18n to data-i18n elements after DOM ready
function applyI18n() {
  ...
  if (aiInp) aiInp.placeholder = t('type_message');
}
...
function _anthrosBoot() {
  ...
  (function() { var isDark = document.documentElement.classList.contains('dark'); var icon = document.getElementById('themeToggleIcon'); if (icon) icon.className = isDark ? 'fa-regular fa-moon' : 'fa-solid fa-moon'; }());
